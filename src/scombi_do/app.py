...
@click.command()
@click.option('--red-channel-input', '-r', 'red_channel_input', help='Input STAC catalog for red channel')
@click.option('--green-channel-input', '-g', 'green_channel_input', default=None, help='Input STAC catalog for green channel')
@click.option('--blue-channel-input', '-b', 'blue_channel_input', default=None, help='Input STAC catalog for blue channel')
@click.option('--red-band', 'red_band', help='Common band name for red channel')
@click.option('--green-band', 'green_band', default=None, help='Common band name for green channel')
@click.option('--blue-band', 'blue_band', default=None, help='Common band name for blue channel')
@click.option('--aoi', '-a', 'aoi', default=None, help='Area of interest in WKT')
@click.option('--conf', default=None, help='Path to optional configuration file')
...
@click.option('--s_expression', 's_expression', multiple=True, default=None, help='s expression for composite channels')
